 ...
 // Sample base64 architecture diagram (placeholder)
 ...
 export const mockProjects: Project[] = [
   {
     ...
     jiraUrl: 'https://jira.example.com/project/ECOM',
     githubRepoUrl: 'https://github.com/Kani2k1/SDLC.git',
   ...
   },
   {
     ...
     jiraUrl: 'https://jira.example.com/project/HRMS',
     githubRepoUrl: 'https://github.com/Kani2k1/SDLC.git',
   ...
   },
   {
     ...
     jiraUrl: 'https://jira.example.com/project/DASH',
     githubRepoUrl: 'https://github.com/Kani2k1/SDLC.git',
