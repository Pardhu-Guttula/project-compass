...
const projectsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(selectProject.fulfilled, (state, action: PayloadAction<{ project: Project | null; session: Session | null; jiraData?: any }>) => {
        state.loading = false;
        state.selectedProject = action.payload.project;
        state.jiraData = action.payload.jiraData; // ✅ store it
